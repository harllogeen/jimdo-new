      ...
      <div className="bg-blue-500">
        <nav className="fixed top-0 px-8 py-4 flex justify-between items-center bg-white shadow-md  w-full z-50 ">
          ...
          >
            ...
            <DropDown
              className="absolute top-12 right-8 bg-white "
              show={openHelpCenter}
            >
              <div>
                <div className="grid justify-center items-center text-#303159 my-4  w-full font-GilroyBold space-y-6">
                  <div className="text-xl text-fcGray4 font-extrabold">
                  ...
                  <Link to="/helpcenter/contact" className="">
                    <h2 className="text-[18px] text-fcNavy6 font-bold hover:text-primary">
                      Contact Support
                      <br />
                      <span className="text-[12px] ">
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            <div className="flex items-center mb-8">
              ...
              <button className="navbar-close">
                <svg
                  className="h-6 w-6 text-gray-900 font-bold cursor-pointer hover:text-primary"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
            ...
            <div>
              <ul>
                <li className="mb-1">
                  <Link
                    className="block p-4 text-sm  text-gray-900 font-bold hover:bg-blue-50 hover:text-blue-600 rounded"
                    to="/"
                  >
                    Home
                  </Link>
            ...
            <div className="mt-auto">
              <div className="pt-6">
                <Link
                  className="block px-4 py-3 mb-3 leading-loose text-xs text-center  md:leading-none bg-gray-50 hover:bg-gray-100 rounded-sm"
                  to="/"
                >
                  Sign in
                </Link>
                <Link
                  className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white  bg-blue-600 hover:bg-blue-700  rounded-sm"
                  to="/"
                >
                  Sign Up
                </Link>
              </div>
              <p className="my-4 text-xs text-center text-gray-900 font-bold">
