...
import Data from "../Pricing/Table/Data";
...
const Website = () => {
  ...
  const pricingArray3 = [
    {
      title: "All PLAY features, plus:",
      icon: <HiCheck />,
      description: "Domain included ",
    },
    {
      icon: <HiCheck />,
      description: "Ad-free",
  ...
  return (
    <div>
      {/* price card */}
      <div className="">
        <div className="grid grid-cols-4 mx-20 my-16 ">
          <div className="bg-white mt-4">
            <div className="text-center justify-center items-center mx-auto">
              <p className="text-[#010334] font-semibold pt-6 ">UNLIMITED</p>
          ...
          <div className="bg-white shadow-lg scale-110 ">
            ...
            <div className="text-center justify-center items-center mx-auto">
              <p className="text-[#010334] font-semibold pt-6 text-sm ">GROW</p>
          ...
          <div className="bg-white border-r-2 border-fcGray4 mt-4">
            <div className="text-center justify-center items-center mx-auto">
              <p className="text-[#010334] font-semibold pt-6 ">UNLIMITED</p>
              <p className="text-fcGray2">Your toolbox for success</p>
              <p className="font-bold text-[#010334] pt-6 text-2xl">
              ...
              <p className="text-fcGray2 text-sm py-2">per month</p>
              <Button className=" text-primary px-6 border-2 border-fcGray4 py-2 font-bold">
                Get Started
              </Button>
            </div>
            <div className="py-8">
              {pricingArray3.map((e, i) => {
                return (
                  <div key={i} className="my-2 px-10">
                    <div className="text-[#010334] font-semibold text-sm ">
                      {e.title}
                    </div>
                    <div className="flex items-center text-sm  font-serif ">
      ...
      <div className="">
        ...
        <div className="text-center text-fcNavy3">
          ...
          <p className="text-4xl pt-8  pb-10" data-aos="zoom-out-up">
            Made in Nigeria, 2023
          </p>
        </div>
      </div>
    </div>
